const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Workshop-OqhaDfnX.js","assets/card-ao4MF0GX.js","assets/scroll-area-D32bQ35H.js","assets/select-DTc9TCj-.js","assets/index-BHuraKdI.js","assets/chevron-down-D7GD2-2C.js","assets/slider-DlsXYLYo.js","assets/RarityWorkshop-DEjzToMl.js","assets/lock-DXs5Sw2E.js","assets/Rules-PjkQRrZF.js","assets/Vault-DCTMask6.js","assets/pinata-L-R8UZ9G.js","assets/Settings-Cap34pGS.js"])))=>i.map(i=>d[i]);
...
function useConfirmDestructive() {
...
function ConfirmDestructiveDialog() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialog, { open: isOpen, onOpenChange: (open) => !open && handleCancel(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { className: "bg-card border border-border rounded-xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { className: "text-lg font-semibold text-foreground", children: title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogDescription, { className: "text-sm text-muted-foreground", children: description })
    ] }),
...
const MenuIcon = (props) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
  "svg",
  {
...
const XIcon = (props) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: "24",
...
const HeartIcon = (props) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: "24",
    ...
    "aria-label": "Heart",
    ...props,
    children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z" })
  }
);
const DownloadIcon = (props) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: "24",
...
const RefreshCwIcon = (props) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: "24",
...
const SearchIcon = (props) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: "24",
...
const FilterIcon = (props) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  "svg",
  {
    xmlns: "http://www.w3.org/2000/svg",
    width: "24",
    ...
    "aria-label": "Filter",
    ...props,
    children: /* @__PURE__ */ jsxRuntimeExports.jsx("polygon", { points: "22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3" })
  }
);
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border py-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6 text-center text-xs text-muted-foreground font-medium", children: [
    "© 2026. Built with",
    " ",
    /* @__PURE__ */ jsxRuntimeExports.jsx(HeartIcon, { className: "inline w-3 h-3 text-red-500 fill-red-500 mx-0.5" }),
    " ",
    "using",
    " ",
    /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function Header({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "flex-shrink-0 bg-card border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6 py-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-4 min-w-0 flex-shrink-0", children: currentProject ? /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          variant: "ghost",
          size: "sm",
      ...
      currentProject && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden lg:flex items-center gap-1 flex-1", children: navItems.map((item) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              className: `motion-button motion-press-snappy relative text-sm font-medium px-3 h-9 rounded-lg overflow-hidden ${isActive ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:text-foreground hover:bg-muted"}`,
              children: [
                item.label,
                !isActive && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute bottom-0 left-1/2 -translate-x-1/2 w-0 h-[2px] bg-foreground/30 rounded-full transition-all duration-hover ease-apple group-hover:w-4/5 opacity-0 hover:opacity-100" })
              ]
            },
            item.id
          );
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: mobileMenuOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(XIcon, { className: "w-5 h-5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(MenuIcon, { className: "w-5 h-5" })
          }
        )
      ] }),
      currentProject && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden lg:flex items-center gap-3 text-right flex-shrink-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold text-foreground truncate", children: currentProject.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-medium", children: currentProject.blockchain })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SaveStatusIndicator, { status: saveStatus })
      ] })
    ] }),
    currentProject && mobileMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "lg:hidden mt-3 pt-3 border-t border-border flex flex-col gap-1 animate-slide-in", children: [
      navItems.map((item) => {
        const isActive = currentView === item.id;
        return /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            className: `motion-button motion-press-snappy text-sm font-medium px-3 h-10 justify-start rounded-lg ${isActive ? "bg-primary text-primary-foreground" : "text-muted-foreground hover:text-foreground hover:bg-muted"}`,
            children: item.label
          },
          item.id
        );
      }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 pt-2 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3 px-3 py-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold text-foreground truncate", children: currentProject.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground font-medium mt-0.5", children: currentProject.blockchain })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(SaveStatusIndicator, { status: saveStatus })
      ] }) })
    ] })
...
function CreateProjectDialog({
  ...
  const [collectionSize, setCollectionSize] = reactExports.useState("1000");
  const [pixelArtMode, setPixelArtMode] = reactExports.useState(false);
  const handleCreate = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "bg-card border border-border max-w-xl rounded-2xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "text-xl font-semibold text-foreground", children: "New project" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { className: "text-muted-foreground text-sm", children: "Configure your collection settings. Default format: Ethereum (ERC-721)" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5 py-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-4 bg-muted/30 border border-border rounded-xl transition-all duration-hover ease-apple hover:bg-muted/40", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Label,
          {
            htmlFor: "pixel",
            className: "text-foreground font-medium text-sm",
            children: "Pixel art mode"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Switch,
...
function NewProjectTile({ onClick }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      ...
      style: {
        transition: "transform var(--motion-press) var(--ease-spring-snap), border-color var(--motion-component) var(--ease-apple), background-color var(--motion-component) var(--ease-apple), box-shadow var(--motion-hover) var(--ease-apple)"
      },
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-full border-2 border-dashed border-border flex items-center justify-center transition-all duration-component ease-apple group-hover:border-primary/40 group-hover:scale-110 group-active:scale-105", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "w-8 h-8 text-muted-foreground transition-colors duration-hover ease-apple group-hover:text-foreground" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-muted-foreground uppercase tracking-wider transition-colors duration-hover ease-apple group-hover:text-foreground", children: "Start new project" })
      ] })
    }
  );
}
function ProjectSettingsDialog({
  ...
  const [name, setName] = reactExports.useState("");
  const [symbol, setSymbol] = reactExports.useState("");
  const [collectionSize, setCollectionSize] = reactExports.useState("");
  const [pixelArtMode, setPixelArtMode] = reactExports.useState(false);
  reactExports.useEffect(() => {
    if (project) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "bg-card border border-border max-w-xl rounded-2xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "text-xl font-semibold text-foreground", children: "Project settings" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { className: "text-muted-foreground text-sm", children: "Update your project configuration" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5 py-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function ProjectTile({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      onClick: onOpen,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "inline-flex items-center px-3 py-1 bg-muted/40 border border-border rounded-full mb-4 transition-all duration-hover ease-apple group-hover:border-primary/30", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-semibold tracking-wider uppercase text-muted-foreground", children: project.blockchain || "SOL" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-2xl font-bold text-foreground mb-2 tracking-tight", children: project.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground font-medium mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "uppercase tracking-wide", children: [
          project.collectionSize,
          " units protocol"
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs text-muted-foreground/60 font-medium mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "uppercase tracking-wider", children: "Initialized" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: formatDate(project.createdAt) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute top-6 right-6 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-component ease-apple", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              variant: "ghost",
...
function Dashboard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full flex flex-col overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-16 sm:mb-20 fade-in", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 lg:gap-12", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-semibold tracking-[0.2em] uppercase text-muted-foreground/60", children: "Professional suite" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-black tracking-tighter mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground", children: "GENESIS" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground/40", children: ".ENGINE" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:text-right lg:max-w-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: "Industrial-grade generative architecture for high-fidelity digital artifacts." }) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 stagger-grid", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(NewProjectTile, { onClick: () => setIsCreateOpen(true) }),
...
function cleanupLegacyArtifacts() {
  ...
  try {
    ...
    for (let i = 0; i < localStorage.length; i++) {
      ...
      if (key == null ? void 0 : key.startsWith(LEGACY_BACKUP_PREFIX)) {
...
function isStorageNearQuota(data) {
  const size = getStorageSize(data);
  return size > 4.5 * 1024 * 1024;
}
const Workshop = reactExports.lazy(() => __vitePreload(() => import("./Workshop-OqhaDfnX.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0));
const RarityWorkshop = reactExports.lazy(() => __vitePreload(() => import("./RarityWorkshop-DEjzToMl.js"), true ? __vite__mapDeps([7,1,2,6,4,8]) : void 0));
const Rules = reactExports.lazy(() => __vitePreload(() => import("./Rules-PjkQRrZF.js"), true ? __vite__mapDeps([9,2]) : void 0));
const Preview = reactExports.lazy(() => __vitePreload(() => import("./Preview-BexnwFzu.js"), true ? [] : void 0));
const Builder = reactExports.lazy(() => __vitePreload(() => import("./Builder-RxcfdVZJ.js"), true ? [] : void 0));
const Vault = reactExports.lazy(() => __vitePreload(() => import("./Vault-DCTMask6.js"), true ? __vite__mapDeps([10,11,8,4,2,5,1]) : void 0));
const Settings = reactExports.lazy(() => __vitePreload(() => import("./Settings-Cap34pGS.js"), true ? __vite__mapDeps([12,11,2,3,4,5]) : void 0));
function getDefaultSettings(blockchain) {
  const metadataFormatMap = {
    SOL: "solana",
    ETH: "ethereum",
    POLYGON: "polygon",
    BNB: "bnb",
  ...
  return {
    ...
    royaltiesPercent: 5,
    pinataApiKey: "",
    solanaCreators: blockchain === "SOL" ? [{ address: "", share: 100 }] : void 0
  };
}
function validateProject(project) {
  ...
  if (!["ICP", "ETH", "SOL", "POLYGON", "BNB", "BASE"].includes(
    project.blockchain
  ))
    return false;
...
function sanitizeProject(project) {
  ...
  try {
    let blockchain = "ETH";
    if ((_a2 = project.settings) == null ? void 0 : _a2.metadataFormat) {
      const formatToBlockchain = {
        solana: "SOL",
        ethereum: "ETH",
        polygon: "POLYGON",
        bnb: "BNB",
    ...
    } else if (["ICP", "ETH", "SOL", "POLYGON", "BNB", "BASE"].includes(
      project.blockchain
    )) {
    ...
    let solanaCreators = void 0;
    if (blockchain === "SOL") {
      if (Array.isArray((_b2 = project.settings) == null ? void 0 : _b2.solanaCreators) && project.settings.solanaCreators.length > 0) {
        solanaCreators = project.settings.solanaCreators.filter(
          (c) => c && typeof c.address === "string" && typeof c.share === "number"
        ).map((c) => ({
    ...
    const sanitized = {
      ...
      collectionSize: Math.max(
        1,
        Number.parseInt(project.collectionSize) || 1e3
      ),
      pixelArtMode: Boolean(project.pixelArtMode),
      layers: Array.isArray(project.layers) ? project.layers.filter(
        (l) => l && typeof l.id === "string" && typeof l.name === "string" && Array.isArray(l.traits)
      ) : [],
      rules: Array.isArray(project.rules) ? project.rules.filter(
        (r2) => r2 && typeof r2.id === "string" && r2.primaryTrait && Array.isArray(r2.incompatibleTraits)
      ) : [],
      customTokens: Array.isArray(project.customTokens) ? project.customTokens.filter(
        (t) => t && typeof t.id === "string" && typeof t.name === "string"
      ) : [],
      generatedNFTs: Array.isArray(project.generatedNFTs) ? project.generatedNFTs.filter(
        (n) => n && typeof n.id === "number" && typeof n.dna === "string" && n.metadata
      ) : [],
      createdAt: typeof project.createdAt === "number" ? project.createdAt : Date.now(),
      lastGeneratedAt: typeof project.lastGeneratedAt === "number" ? project.lastGeneratedAt : void 0,
      ...
      ipfsPublishing: project.ipfsPublishing && typeof project.ipfsPublishing === "object" ? {
        status: [
          ...
          "uploaded",
          "upload-failed"
        ].includes(project.ipfsPublishing.status) ? project.ipfsPublishing.status : "not-ready",
        uploadProgress: typeof project.ipfsPublishing.uploadProgress === "number" ? project.ipfsPublishing.uploadProgress : void 0,
        errorMessage: typeof project.ipfsPublishing.errorMessage === "string" ? project.ipfsPublishing.errorMessage : void 0,
        imageDirCID: typeof project.ipfsPublishing.imageDirCID === "string" ? project.ipfsPublishing.imageDirCID : void 0,
        metadataCID: typeof project.ipfsPublishing.metadataCID === "string" ? project.ipfsPublishing.metadataCID : void 0
      } : { status: "not-ready" },
      settings: project.settings && typeof project.settings === "object" ? {
        ...
        metadataFormat: [
          ...
          "base",
          "icp"
        ].includes(project.settings.metadataFormat) ? project.settings.metadataFormat : blockchain === "SOL" ? "solana" : blockchain === "POLYGON" ? "polygon" : blockchain === "BNB" ? "bnb" : blockchain === "BASE" ? "base" : blockchain === "ICP" ? "icp" : "ethereum",
    ...
    sanitized.rules = sanitized.rules.map((r2) => {
      if (r2.trait1 && r2.trait2) {
        return {
          id: r2.id,
          type: r2.type,
          primaryTrait: r2.trait1,
          incompatibleTraits: [r2.trait2]
        };
      }
      return r2;
    });
...
function normalizeProjects(projects) {
  ...
  let latestGeneratedProject = null;
...
function loadProjectsFromStorage() {
  try {
    ...
    const sanitized = parsed.map(sanitizeProject).filter((p) => p !== null);
    if (sanitized.length !== parsed.length) {
      console.warn(
        `Recovered ${sanitized.length} of ${parsed.length} projects`
      );
      ue.warning(`Recovered ${sanitized.length} projects`);
    }
    const normalized = normalizeProjects(sanitized);
    return normalized;
  } catch (error) {
    console.error("Error loading projects from storage:", error);
    ue.error("Storage error - data may be corrupted");
    return [];
  }
}
function App() {
  ...
  reactExports.useEffect(() => {
    ...
    const timeoutId = setTimeout(() => {
      ...
      if (isStorageNearQuota(normalizedProjects)) {
        ue.warning("Storage nearly full - consider exporting projects");
      }
      ...
      if (result.success) {
        ...
        if (((_a2 = result.error) == null ? void 0 : _a2.includes("QuotaExceededError")) || ((_b2 = result.error) == null ? void 0 : _b2.includes("quota"))) {
  ...
  const saveProjects = reactExports.useCallback((updatedProjects) => {
    setProjects(updatedProjects);
  }, []);
  const updateCurrentProject = reactExports.useCallback(
    (updater) => {
  ...
  const updateProject = reactExports.useCallback(
    (projectId, updater) => {
      setProjects((prevProjects) => {
        const updated = prevProjects.map((p) => {
  ...
  const openProject = reactExports.useCallback(
    (id) => {
      const project = projects.find((p) => p.id === id);
      if (!project) {
        ue.error("Project not found");
        return;
      }
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-screen bg-background text-foreground flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 border-2 border-primary border-t-transparent rounded-full animate-spin mx-auto mb-3" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-muted-foreground", children: "Loading..." })
    ] }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-screen bg-background text-foreground flex flex-col overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Header,
      {
        currentView,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full page-enter", children: [
      ...
      currentView !== "dashboard" && currentProject && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        reactExports.Suspense,
        {
          fallback: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 border-2 border-primary border-t-transparent rounded-full animate-spin mx-auto mb-3" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-muted-foreground", children: "Loading..." })
          ] }) }),
          children: [
            currentView === "workshop" && /* @__PURE__ */ jsxRuntimeExports.jsx(
              Workshop,
              {
            ...
            currentView === "rarity" && /* @__PURE__ */ jsxRuntimeExports.jsx(
              RarityWorkshop,
              {
                project: currentProject,
                onUpdateProject: updateCurrentProject
            ...
            currentView === "rules" && /* @__PURE__ */ jsxRuntimeExports.jsx(
              Rules,
              {
                project: currentProject,
                onUpdateProject: updateCurrentProject
            ...
            currentView === "preview" && /* @__PURE__ */ jsxRuntimeExports.jsx(
              Preview,
              {
                project: currentProject,
                onUpdateProject: updateCurrentProject
            ...
            currentView === "builder" && /* @__PURE__ */ jsxRuntimeExports.jsx(
              Builder,
              {
                project: currentProject,
                onUpdateProject: updateCurrentProject
            ...
            currentView === "vault" && /* @__PURE__ */ jsxRuntimeExports.jsx(
              Vault,
              {
                project: currentProject,
                onUpdateProject: updateCurrentProject
            ...
            currentView === "settings" && /* @__PURE__ */ jsxRuntimeExports.jsx(
              Settings,
              {
                project: currentProject,
                onUpdateProject: updateCurrentProject
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ConfirmDestructiveDialog, {})
  ] });
}
...
export {
  ...
  useFocusGuards as W,
  X,
  ReactRemoveScroll as Y,
  FocusScope as Z,
  DismissableLayer as _,
  DialogContent as a,
  cva as a0,
  DialogHeader as b,
  ...
  usePrevious as m,
  cn as n,
  AlertDialogContent as o,
  AlertDialogHeader as p,
  AlertDialogTitle as q,
  reactExports as r,
  AlertDialogDescription as s,
  AlertDialogFooter as t,
  ue as u,
  AlertDialogCancel as v,
  AlertDialogAction as w,
  useConfirmDestructive as x,
  useId as y,
  Presence as z
};
